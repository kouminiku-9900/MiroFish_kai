...
[Video Link](https://www.bilibili.com/video/BV1VYBsBHEMY/)

### 2. Dream of the Red Chamber Lost Ending Simulation

[Video Link](https://www.bilibili.com/video/BV1cPk3BBExq)
...
```env
# Gemini configuration (default and only runtime LLM)
LLM_PROVIDER=google
LLM_MODEL_NAME=gemini-3.1-flash-lite-preview
GOOGLE_AI_API_KEY=your_google_ai_api_key_here

# Flask / session secret (replace with a long random string)
SECRET_KEY=put_a_long_random_secret_here

# Compatibility fields (unused by the current Gemini runtime; may be left empty)
LLM_API_KEY=
LLM_BASE_URL=
...
# Gemini boost configuration (optional)
