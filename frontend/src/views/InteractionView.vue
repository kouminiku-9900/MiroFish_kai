    ...
    <header class="app-header">
      ...
      <div class="header-right">
        <div class="workflow-step">
          ...
          <span class="step-name">{{ $t('main_view.steps.step5') }}</span>
        </div>
...
const statusText = computed(() => {
  ...
  if (currentStatus.value === 'processing') return t('main_view.status.processing')
  return t('main_view.status.ready')
})
