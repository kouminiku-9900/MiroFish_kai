        ...
        <div class="card-header">
          ...
          <div class="card-status-icons">
            <span 
              ...
              :title="$t('main_view.steps.step1')"
            >◇</span>
            <span 
              class="status-icon available" 
              :title="$t('main_view.steps.step2')"
            >◈</span>
            <span 
              class="status-icon" 
              :class="{ available: project.report_id, unavailable: !project.report_id }"
              :title="$t('main_view.steps.step4')"
            >◆</span>
          </div>
        </div>
        ...
        <div class="card-files-wrapper">
          ...
          <div class="files-list" v-if="project.files && project.files.length > 0">
            ...
            <div v-if="project.files.length > 3" class="files-more">
              {{ $t('history.more_files', { count: project.files.length - 3 }) }}
            </div>
          </div>
          <!-- 无文件时的占位 -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                <div class="modal-label">{{ $t('history.modal.simulation_requirement') }}</div>
                <div class="modal-requirement">{{ selectedProject.simulation_requirement || '--' }}</div>
              </div>

              <!-- 文件列表 -->
              <div class="modal-section">
                <div class="modal-label">{{ $t('history.modal.related_files') }}</div>
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">{{ $t('history.modal.playback') }}</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-text">{{ $t('main_view.steps.step1') }}</span>
              </button>
              <button 
              ...
              >
                ...
                <span class="btn-icon">◈</span>
                <span class="btn-text">{{ $t('main_view.steps.step2') }}</span>
              </button>
              <button 
              ...
              >
                ...
                <span class="btn-icon">◆</span>
                <span class="btn-text">{{ $t('main_view.steps.step4') }}</span>
              </button>
            </div>
            <!-- 不可回放提示 -->
...
const getSimulationTitle = (requirement) => {
  if (!requirement) return '未命名シミュレーション'
...
const loadHistory = async () => {
  try {
    ...
    console.error('履歴プロジェクトの読み込みに失敗しました:', error)
    projects.value = []
  } finally {
    loading.value = false
  }
