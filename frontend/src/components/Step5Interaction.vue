      ...
      <div class="right-panel" ref="rightPanel">
        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-text">
            <span class="action-bar-title">{{ $t('components.step5.action_bar.title') }}</span>
            <span class="action-bar-subtitle mono">{{ $t('components.step5.action_bar.subtitle', { count: profiles.length }) }}</span>
          </div>
        </div>
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>{{ $t('components.step5.tabs.report_chat') }}</span>
            </button>
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : $t('components.step5.tabs.agent_chat_placeholder') }}</span>
                <svg class="dropdown-arrow" :class="{ open: showAgentDropdown }" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
              </button>
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">{{ $t('components.step5.dropdown.header') }}</div>
                <div 
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || $t('persona.profession_unknown') }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <span>{{ $t('components.step5.tabs.survey') }}</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                <div class="tools-card-name">{{ $t('components.step5.tools.title') }}</div>
                <div class="tools-card-subtitle">{{ $t('components.step5.tools.subtitle') }}</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('components.step5.tools.insight.name') }}</div>
                    <div class="tool-desc">{{ $t('components.step5.tools.insight.desc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('components.step5.tools.panorama.name') }}</div>
                    <div class="tool-desc">{{ $t('components.step5.tools.panorama.desc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('components.step5.tools.quick.name') }}</div>
                    <div class="tool-desc">{{ $t('components.step5.tools.quick.desc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('components.step5.tools.interview.name') }}</div>
                    <div class="tool-desc">{{ $t('components.step5.tools.interview.desc') }}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || $t('persona.profession_unknown') }}</span>
                </div>
              </div>
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">{{ $t('persona.bio') }}</div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? $t('components.step5.chat.report_empty') : $t('components.step5.chat.agent_empty') }}
              </p>
            </div>
            <div 
              ...
              <div class="message-content">
                <div class="message-header">
                  <span class="sender-name">
                    {{ msg.role === 'user' ? $t('components.step5.sender.you') : (chatTarget === 'report_agent' ? $t('components.step5.sender.report_agent') : (selectedAgent?.username || $t('components.step5.sender.agent'))) }}
                  </span>
          ...
          <div class="chat-input-area">
            <textarea 
              v-model="chatInput"
              class="chat-input"
              :placeholder="$t('components.step5.chat.input_placeholder')"
        ...
        <div v-if="activeTab === 'survey'" class="survey-container">
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">{{ $t('components.step5.survey.select_agents') }}</span>
                <span class="selection-count">{{ $t('components.step5.survey.selected_count', { count: selectedAgents.size, total: profiles.length }) }}</span>
              </div>
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || $t('persona.profession_unknown') }}</span>
                  </div>
            ...
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">{{ $t('components.step5.survey.question_label') }}</span>
              </div>
              <textarea 
                v-model="surveyQuestion"
                class="survey-input"
                :placeholder="$t('components.step5.survey.input_placeholder')"
                rows="3"
              ></textarea>
            </div>
            ...
            >
              ...
              <span v-else>{{ $t('components.step5.survey.submit_btn') }}</span>
            </button>
          </div>
          ...
          <div v-if="surveyResults.length > 0" class="survey-results">
            <div class="results-header">
              <span class="results-title">{{ $t('components.step5.survey.results_title') }}</span>
              <span class="results-count">{{ $t('components.step5.survey.results_count', { count: surveyResults.length }) }}</span>
            </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.profession || $t('persona.profession_unknown') }}</span>
                  </div>
                </div>
...
const sendToReportAgent = async (message) => {
  addLog(`Report Agent に送信: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    ...
    addLog('Report Agent から返信がありました')
  } else {
...
const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('先にシミュレーション対象を選択してください')
  }
  
  addLog(`${selectedAgent.value.username} に送信: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    ...
    if (responseContent) {
      ...
      addLog(`${selectedAgent.value.username} から返信がありました`)
    } else {
...
const submitSurvey = async () => {
  ...
  addLog(`アンケートを ${selectedAgents.value.size} 名に送信しています...`)
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      for (const interview of interviews) {
        ...
        surveyResultsList.push({
          agent_id: agentIdx,
          agent_name: agent?.username || `エージェント ${agentIdx}`,
    ...
    addLog(`アンケート送信に失敗しました: ${err.message}`)
  } finally {
...
const loadReportData = async () => {
  ...
  try {
    addLog(`レポートデータを読み込んでいます: ${props.reportId}`)
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`${profiles.value.length} 名のシミュレーション個体を読み込みました`)
    }
  } catch (err) {
